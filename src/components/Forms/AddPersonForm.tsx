  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newPerson: Person = {
        ...
        ...(deathYear ? { deathYear: Number(deathYear) } : {}),
        ...(parentId ? { parentId } : {}),
        ...(notes ? { notes } : {}),
      };
      ...
      treeData.people.push(newPerson);
      ...
      // Notifier le parent que la personne a été ajoutée
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <input
            id="name"
            type="text"
            className="w-full p-2 border border-blue-700 text-gray-700 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={name}
